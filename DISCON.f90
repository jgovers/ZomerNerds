...
REAL(4), PARAMETER           :: VS_RtTq       =     5000                  ! Rated generator torque (HSS side), Nm.
REAL(4), PARAMETER           :: VS_RtTq99       =     4950
...
!=======================================================================
    ...
    GenSpeedF = LPFilter( GenSpeed, DT, CornerFreq, iStatus, 1)     ! This is the first instance of the LPFilter
