...
CONTAINS
    ...
    ! Does the core IPC work
        ...
        SUBROUTINE ColemanTransformInverse(axisDirect, axisQuadr, aziAngle, deltaPAngle, pAngle1, pAngle2, pAngle3)	!pass signal through the inverse Coleman transform
    ...
    SUBROUTINE ColemanTransformInverse(axisDirect, axisQuadr, aziAngle, deltaPAngle, rootMOOP1, rootMOOP2, rootMOOP3)
